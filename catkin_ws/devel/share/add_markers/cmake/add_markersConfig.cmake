...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gurpreet/workspace/home_service_robot_copy/home_service_robot/catkin_ws/src/add_markers/${idir}'.  ${_report}")
    endif()
